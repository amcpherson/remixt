...
if __name__ == '__main__':
    ...
    germline_seeds = range(10, 11)

    genome_params = defaults.copy()
    genome_params['genome_seed'] = range(10, 10+4)
    genome_params['normal_data_seed'] = range(10, 10+4)
    ...
    mixture_params['mixture_seed'] = range(10, 10+4)
    ...
    pyp.sch.setobj(mgd.TempOutputObj('germline_seed', *germline_axis), dict(enumerate(germline_seeds)))
    pyp.sch.setobj(mgd.TempOutputObj('chromosome'), chromosomes)
